...
for ss = 1 : size(sjs, 1)
    ...
    %% phase shuffle here to make peaks meaningless 
    smd = phaseran(smd',1)';
    ...
    save(fullfile(deriv_pth3, ['RandomLaggedMIaround_predictionPeaks1s_slidingWindow.mat']), 'eeg_mi');
    
    
end

%% END OF SCRIPT put this in another script!!
